...
var fixedNavigation = {
    ...
    setup: function() {
        ...
        if ( $(self.header).hasClass('brandedHead') ) {
            ...
            self.offset = 0;
            self.trigger = self.navheight - $(self.navLvl2).outerHeight();
...
var mobileNavigation = {
    ...
    openBranded: function() {

        var self = this;

        $(self.button).addClass('mobileOpen');
        $(self.currentSection).addClass('mobileOpen');
        $(self.navLvl2).addClass('mobileOpen');
        $('body').addClass('mobileOpen');
        
        $(self.navLvl2).height(self.avalableSpace());
    ...
    closeBranded: function() {

        var self = this;

        $(self.button).removeClass('mobileOpen');
        $(self.currentSection).removeClass('mobileOpen');
        $(self.navLvl2).removeClass('mobileOpen');
        $('body').removeClass('mobileOpen');

        $(self.navLvl2).height('auto');
...
var desktopNavigation = {
    ...
    setStamp: function() {
        ...
        {
            html = '<ul class="breadcrumb"><li><span>Jutarnji</span></li></ul>';
        }
