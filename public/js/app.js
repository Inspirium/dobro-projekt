...
var projection = d3.geoMercator().center([16.4, 44.7]).scale(4500).translate([width / 2, height / 2]);
        ...
        while (s) {
            ...
            if (s) {
                ...
                if (pointInPolygon(projection.invert([x, y]), p[0])) {
                    svg.append("image").attr('width', 20).attr('height', 20).attr('xlink:href', '/img/col_' + i + '.svg').attr('class', 'locator').attr("transform", function (d) {
