...
d3.json("js/hrv.json", function (error, uk) {
    ...
    svg.append("path").datum(topojson.feature(uk, uk.objects.subunits)).attr("class", "hrvatska").attr("d", path);
});
...
window.d3 = __webpack_require__(4);
window.topojson = __webpack_require__(10);
